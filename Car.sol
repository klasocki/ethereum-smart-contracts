...
contract Car is ERC721, ERC721Enumerable, Ownable {
    ...
    function safeMint(address to, string memory model, string memory colour, uint16 yearOfMatriculation, uint24 originalValue, uint24 kms) public onlyOwner {
        ...
        carsData[tokenId] = CarData(model, colour, yearOfMatriculation, originalValue, kms);
    }
    ...
    function getCarData(uint _carId) public view returns(CarData memory) {
